 ...
 * @author hecto
 */
public class RRHH extends javax.swing.JInternalFrame {
Connection conn = null;
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Ingrese los datos del empleado RRHH");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (conn != null) {
                ...
                qry = "INSERT INTO RRHH (id, nombre, apellido, numero_empleado, "
        ...
        try {
            ...
            if (conn != null) {
                ...
                if (codValue != null && !codValue.trim().isEmpty()) { // Verifica que el ID no esté vacío
                    ...
                    qry = "UPDATE RRHH SET nombre=?, apellido=?, numero_empleado=?, "
